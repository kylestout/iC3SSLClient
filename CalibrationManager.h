...
static const int COMPRESSOR_CYCLES_CALIBRATION_CHECK = 6;
static const int COMPRESSOR_CYCLES_ADJUSTMENT_CHECK = 15;
...
public:
    ...
    void checkIfCalibrated();
    void checkIfAdjustmentsNeedMade();
